...
<th>03-22441234</th>
  ...
  <?php
$serverName = "simplewebtp123456.database.windows.net";
...
{
echo "<tr>";
echo "<td>". $row['restaurant_id'] . "</td>"; echo "<td>". $row['restaurant_name'] ."</td>";
echo "<td>". $row['restaurant_address'] . "</td>"; echo "<td>". $row['restaurant_phone'] . "</td>"; echo "</tr>";
}
